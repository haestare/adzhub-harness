...
| Entrada do composer | ✅ anexo de CSV/TSV/JSON/TXT/MD lido no browser e cortado em 40 mil caracteres pelo harness; ditado pela API de fala do navegador (sem segunda chave, ver §5 do paper) |
